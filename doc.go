...
The package [types](https://godoc.org/github.com/polkadot-go/api/v4/types/) exports a number
...
1. Vectors, lists, series, sets, arrays, slices: https://godoc.org/github.com/polkadot-go/api/v4/types/#example_Vec_simple

2. Structs: https://godoc.org/github.com/polkadot-go/api/v4/types/#example_Struct_simple
...
For more information about the types sub-package, see https://godoc.org/github.com/polkadot-go/api/v4/types
*/
package gsrpc
